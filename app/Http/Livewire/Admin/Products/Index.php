...
class Index extends Component
{
    ...
    //     ])->paginate(20);
    //     if($this->quantity == 0)
    //         $this->currentStatus = "Out of Stock";
    //     elseif($this->quantity < 20)
    //     $this->currentStatus = "Low Stock";
    //     else
    //     $this->currentStatus = "Available";
    //     return view('livewire.admin.products.index', ['products' => $products, 'categories' => $categories, 'brands' => $brands, 'marikina_products'=>$marikina_products, 'ajuan_products' => $ajuan_products, 'ortigas_products' => $ortigas_products ]);
    // }
    public $activeTab;
        ...
        try {
            ...
            $this->resetInput();
               ...
               if($e->getCode() == "23000"){ //23000 is sql code for integrity constraint violation
                   ...
                   session()->flash('error', 'Can\'t delete the item! Record exist on other tables!');
                   $this->dispatchBrowserEvent('close-modal');
                   $this->resetInput();
               }
           }
