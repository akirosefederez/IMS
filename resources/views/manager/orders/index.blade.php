...
@section('content')
    @include('manager.orders.orders-modal')
    <div>
        @if (session('message'))
    ...
    <div class="card mb-5">
        <div class="card-header">
            <h3 class="mt-2">DELIVERY
                {{-- -  <form action="{{url('manager/orders/search')}}" method="get">
                ...
                {{-- <a href="{{ url('manager/orders/create') }}" class="btn btn-primary btn-sm text-white float-end"
                    >CREATE</a> --}}
                <a href="{{ url('manager/orders/ordersPDF') }}" class="btn btn-sm text-white float-right mx-1"
        ...
        <div class="card-body" style="background-color: #ffffff">
            <div class="mb-3">
                <form action="{{ route('orders.search2') }}" method="GET" role="search">
                        ...
                        <div class="input-group" style="max-width:18rem;">
                            ...
                            <div class="input-group-append">
                                <a class="btn btn-danger" type="button" title="Refresh page"
                                    href="{{ url('manager/orders') }}"><i class="fas fa-sync-alt"></i></a>
                            </div>
                        </div>
                    </div>
                </form>
                                ...
                                <tbody>
                                    @forelse ($ajuan_order_items as $order_item)
                                        <tr>
                                            ...
                                            <td style="word-wrap: break-word;min-width: 250px;max-width: 250px;" class="text-truncate">{{ $order_item->serialnumber }}</td>
                                            ...
                                            {{-- -
                                    <td><a href="{{ url('manager/orders/'.$item->id) }}" class="btn btn-primary btn-sm">View</a>
                                        <a href="{{ url('manager/orders/'.$item->id.'/delete') }}" onclick="return confirm('Are you sure you want to delete this data?')" class="btn btn-danger btn-sm">Delete</a></td> - --}}
                                        </tr>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="{{ url('manager/orders/' . $order_item->id . '/delete') }}"
                                        ...
                                        <div class="modal fade" id="updateCheckoutModal-{{ $order_item->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-xl">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ url('manager/orders/' . $order_item->id) }}"
                                                            ...
                                                            <div class="mb-3">
                                                                <div class="form-row">
                                                                    ...
                                                                    <div class="col">
                                                                        ...
                                                                        <input type="text" required name="srnumber" id="srnumber"
                                                                            class="form-control"
                                                                    ...
                                                                    <div class="col">
                                                                        ...
                                                                        <input type="text" required name="ponumber" id="ponumber"
                                                                            class="form-control"
