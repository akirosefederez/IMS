...
@section('content')
    @include('manager.returns.returns-modal')
    <div>
        @if (session('message'))
    ...
    <div class="card mb-5">
        ...
        <div class="card-body" style="background-color: #ffffff">
            ...
            <div class="mb-3">
                <form action="{{ route('returns.search2') }}" method="GET" role="search">
                        ...
                        <div class="input-group" style="max-width:18rem;">
                            ...
                            <div class="input-group-append">
                                <a class="btn btn-danger" type="button" title="Refresh page"
                                    href="{{ url('manager/returns') }}"><i class="fas fa-sync-alt"></i></a>
                            </div>
                        </div>
                    </div>
                </form>
                                ...
                                <tbody>
                                    @forelse ($ajuan_return_slips as $return_slip)
                                        <tr>
                                            ...
                                            <td style="word-wrap: break-word;min-width: 250px;max-width: 250px;" class="text-truncate">
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="{{ url('manager/returns/' . $return_slip->id . '/delete') }}"
                                        ...
                                        <div class="modal fade" id="updateCheckoutModal-{{ $return_slip->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-xl">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ url('manager/returns/' . $return_slip->id) }}"
