...
@section('content')
    @include('manager.checkin.checkin-modal')
    <div>
        @if (session('message'))
    ...
    <div class="card mb-5">
        <div class="card-header">
            <h3 class="mt-2 text">CHECK-IN
                <a href="{{ url('manager/checkins/checkinsPDF') }}"
                    class="btn btn-danger btn-sm text-white float-right mx-1" title="Export table data to PDF">Export to
                    PDF</a>
        ...
        <div class="card-body" style="background-color: #ffffff">
            <div class="mb-3">
                <form action="{{ route('checkins.search2') }}" method="GET" role="search">
                        ...
                        <div class="input-group" style="max-width:18rem;">
                            ...
                            <div class="input-group-append">
                                <a class="btn btn-danger" type="button" title="Refresh page"
                                    href="{{ url('manager/checkins') }}"><i class="fas fa-sync-alt"></i></a>
                            </div>
                        </div>
                    </div>
                </form>
                                    ...
                                    @forelse ($ajuan_checkins as $checkin)
                                        <tr>
                                            ...
                                            <td class="text-nowrap">
                                                {{-- <a href="{{ url('manager/checkins/'.$checkin->id.'/edit') }}" class="btn btn-sm btn-success">Edit</a> --}}
                                                {{-- View --}}
                                                <a href="#" data-toggle="modal"
                                                    data-target="#viewCheckinModal-{{ $checkin->id }}" class="btn btn-sm btn-primary"
                                                    title="View item">
                                                    <i class="bi bi-eye"></i>
                                                </a>
                                                ...
                                                {{-- Delete --}}
                                                <a href="{{ url('manager/checkins/' . $checkin->id . '/delete') }}"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="{{ url('manager/orders/' . $checkin->id . '/delete') }}"
                                        ...
                                        <div class="modal fade" id="editCheckinModal-{{ $checkin->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-xl">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ url('manager/checkins/' . $checkin->id) }}" method="POST"
                                                            ...
                                                            <div class="mb-3">
                                                                <div class="form-row">
                                                                    ...
                                                                    <div class="col">
                                                                        <label>SKU</label>
                                                                        <input type="text" name="sku" class="form-control"
                                                                            disabled value="{{ old('sku', $checkin->sku) }}" />
                                                                    </div>

                                                                    <div class="col">
                                                                        <label>Model</label>
                                                                        <input type="text" name="model" class="form-control"
                                                                            disabled value="{{ old('model', $checkin->model) }}" />
                                                                    </div>
