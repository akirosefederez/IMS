    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ url('manager/checkins') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                        <div class="form-row">
                            <div class="col">
                            ...
                            <div class="col">
                                <label>PO No.</label>
                                <input type="text" name="ponumber" class="form-control" placeholder="Enter PO no." required/>
                            </div>
                            <div class="col">
                                <label>STR No.</label>
                                <input type="text" name="strnumber" class="form-control" placeholder="Enter STR no." required />
                            </div>
                        </div>
                    </div>
