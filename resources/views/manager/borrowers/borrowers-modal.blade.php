...
<div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
        <div class="modal-content">
            ...
            <form method="POST" action="{{ url('manager/borrowers/generateForm') }}" enctype="multipart/form-data"
                id="form">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="brnumber" id="brnumber" type="text"
                            class="form-control" required placeholder="Enter BR No."
                            value="{{ old('brnumber', '') }}" />
                        @error('brnumber')
