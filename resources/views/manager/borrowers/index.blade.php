...
@section('content')
    ...
    <div class="card mb-5">
        ...
        <div class="card-body" style="background-color: #ffffff">
            ...
            <div class="mb-3">
                <form action="{{ route('borrowers.search2') }}" method="GET" role="search">
                            ...
                            <tbody>
                                @forelse ($ajuan_borrowers as $borrower)
                                    <tr>
                                        ...
                                        <td style="word-wrap: break-word;min-width: 250px;max-width: 250px;" class="text-truncate">{{ $borrower->serialnumber }}</td>
                                        <td>{{ $borrower->quantity }}</td>
                                        <td class="text-nowrap">

                                            {{-- View Button --}}
                                            <a href="#" data-toggle="modal"
                                                data-target="#viewCheckoutModal-{{ $borrower->id }}" class="btn btn-sm btn-primary"
                                                title="View item">
                                                <i class="bi bi-eye"></i>
                                            </a>
                                    ...
                                    <div class="modal fade" id="updateCheckoutModal-{{ $borrower->id }}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog modal-xl">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ url('manager/borrowers/' . $borrower->id) }}"
                                                            ...
                                                            <div class="form-row">
                                                                <div class="col">
                                                                    ...
                                                                    <input type="text" required name="site" id="site"
                                                                        class="form-control" value="{{ old('site',$borrower->site ) }}"
                                                                ...
                                                                <div class="col">
                                                                    ...
                                                                    <input type="text" required name="address" id="address"
                                                                        class="form-control" value="{{ old('address',$borrower->address ) }}"
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="form-row">
                                                                ...
                                                                <div class="col">
                                                                    ...
                                                                    <input type="date" required name="dateofreturn"
                                                                        id="dateofreturn" disabled class="form-control"
                                                                        value="{{ old('dateofreturn', $borrower->dateofreturn) }}"
                                                                        placeholder="Enter Date of Return" />
                                                                    @error('dateofreturn')
                                                                        <p class="text-danger">{{ $message }}</p>
