                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <div class="form-row">
                            <div class="col">
                                <label>Model</label>
                                <input type="text" wire:model.defer="model" class="form-control" required placeholder="Enter model"/>
                            </div>
                            <div class="col">
                                <label>SKU</label>
                                <input type="text" wire:model.defer="sku" class="form-control" required placeholder="Enter SKU" />
                            </div>
                        </div>
                    </div>
                    <div class="mb-3">
                        <div class="form-row">
                            <div class="col">
                                ...
                                <input type="text" wire:model.defer="productcode" class="form-control" required placeholder="Enter product code" />
                            </div>
                            <div class="col">
                                <label>UOM</label>
                            ...
                            <div class="col">
                                ...
                                <input type="number" min="1" wire:model.defer="quantity" class="form-control" required placeholder="Enter quantity" />
                            </div>
                        </div>
                    </div>
                    <div class="mb-3">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <div class="form-row">
                            <div class="col">
                                <label>Product Code</label>
                                <input type="text" wire:model.defer="productcode" class="form-control" required placeholder="Enter quantity"/>
                            </div>
                            <div class="col">
                                <label>UOM</label>
                                <select wire:model.defer="uom" class="form-control" required>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <div class="form-row">
                            ...
                            <div class="col">
                                <label>Status</label>
                                <input type="text" name="status" class="form-control" value="{{ $currentStatus }}"
                                    disabled />
                            </div>
                        </div>
                    </div>
