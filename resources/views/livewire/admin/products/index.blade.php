<div class="row">
    ...
    @include('livewire.admin.products.modal-form')
    <div class="col-md-12">
        @if (session('message'))
        ...
        <div class="card mb-5">
            <div class="card-header">
                <h3>INVENTORY
                    <a class="btn btn-info btn-sm shadow-none float-right mx-1"
                        href="{{ route('products.export') }}">Export Excel File</a>

                    <a href="{{ url('admin/products/productsPDF') }}"
                            ...
                            <div class="input-group" style="max-width:18rem;">
                                ...
                                <div class="input-group-append">
                                    <a class="btn btn-danger" type="button" title="Refresh page"
                                        href="{{ url('admin/products') }}"><i class="fas fa-sync-alt"></i></a>
                                </div>
                            </div>
                        </div>
                    </form>
