                                                                ...
                                                                <div class="form-row">
                                                                    <div class="col">
                                                                        ...
                                                                        <input type="text" required name="brnumber"
                                                                            ...
                                                                            value="{{ old('brnumber', $borrower->stonumber) }}"
                                                                ...
                                                                <div class="form-row">
                                                                    ...
                                                                    <div class="col">
                                                                        ...
                                                                        <input type="text" name="serialnumber"
                                                                            ...
                                                                            class="form-control"
                                                                            value="{{ old('serialnumber', $borrower->serialnumber) }}"
                                ...
                                <tbody>
                                    @forelse ($marikina_borrowers as $borrower)
                                        <tr>
                                            ...
                                            <td style="word-wrap: break-word;min-width: 350px;max-width: 350px;">
                                                {{ $borrower->itemdescription }}</td>
                                            <td class="text-truncate" style="word-wrap: break-word;min-width: 250px;max-width: 250px;">{{ $borrower->serialnumber }}</td>
                                            <td>{{ $borrower->quantity }}</td>
                                            <td class="text-nowrap text-center">
