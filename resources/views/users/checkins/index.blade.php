    ...
    <div class="card mb-5 mx-5">
        <div class="card-header">
            <h3 class="mt-2 text">CHECK-IN
                <a href="{{ url('/checkins/checkinsPDF') }}" class="btn btn-sm  float-right" style="color:white; background-color: rgb(196, 80, 80);"
        ...
        <div class="card-body" style="background-color: #ffffff">
            <div class="mb-3">
                <form action="{{ route('checkin.search') }}" method="GET" role="search">
                        ...
                        <div class="input-group" style="max-width:18rem;">
                            ...
                            <div class="input-group-append">
                                <a class="btn btn-danger" type="button" title="Refresh page"
                                    href="{{ url('/checkins') }}"><i class="fas fa-sync-alt"></i></a>
                            </div>
                        </div>
                    </div>
                </form>
                            ...
                            <tbody>
                                @forelse ($ajuan_checkins as $checkin)
                                    <tr>
                                        ...
                                        <td>{{ $checkin->sku }}</td>
                                        <td>{{ $checkin->model }}</td>
                                        <td style="word-wrap: break-word;min-width: 350px;max-width: 350px;">{{ $checkin->itemdescription }}</td>
                                        <td class="text-truncate" style="word-wrap: break-word;min-width: 250px;max-width: 250px;">{{ $checkin->serialnumber }}</td>
