...
@section('content')
    @include('admin.purchasereturns.purchasereturns-modal')
    <div>
        @if (session('message'))
    ...
    <div class="card mb-5">
        <div class="card-header">
            <h3 class="mt-2">PURCHASE RETURN
                ...
                <a href="{{ url('admin/purchasereturns/purchasereturnsPDF') }}" class="btn btn-sm text-white float-right"
                        ...
                        <div class="input-group" style="max-width:18rem;">
                            ...
                            <div class="input-group-append">
                                <a class="btn btn-danger" type="button" title="Refresh page"
                                    href="{{ url('admin/purchasereturns') }}"><i class="fas fa-sync-alt"></i></a>
                            </div>
                        </div>
                    </div>
                </form>
                                ...
                                <tbody>
                                    @forelse ($ajuan_purchase_returns as $purchase_return)
                                        <tr>
                                            ...
                                            <td style="word-wrap: break-word;min-width: 250px;max-width: 250px;" class="text-truncate">{{ $purchase_return->serialnumber }}</td>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="{{ url('admin/purchasereturns/' . $purchase_return->id . '/delete') }}"
                                        ...
                                        <div class="modal fade" id="updateCheckoutModal-{{ $purchase_return->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-xl">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ url('admin/purchasereturns/' . $purchase_return->id) }}"
