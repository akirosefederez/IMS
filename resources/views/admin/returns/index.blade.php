...
@section('content')
    ...
    <div class="card mb-5">
        ...
        <div class="card-body" style="background-color: #ffffff">
            ...
            <div class="mb-3">
                <form action="{{ route('returns.search') }}" method="GET" role="search">
                        ...
                        <div class="input-group" style="max-width:18rem;">
                            ...
                            <div class="input-group-append">
                                <a class="btn btn-danger" type="button" title="Refresh page"
                                    href="{{ url('admin/returns') }}"><i class="fas fa-sync-alt"></i></a>
                            </div>
                        </div>
                    </div>
                </form>
            ...
            <div>
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    {{-- DIV A JUAN --}}
                    <div class="tab-pane fade {{ Request::get('tab') === 'ajuan' ? ' show active' : '' }}
                    " id="ajuan" role="tabpanel" aria-labelledby="ajuan-tab" wire:ignore.self>
                                ...
                                <tbody>
                                    @forelse ($ajuan_return_slips as $return_slip)
                                        <tr>
                                            ...
                                            <td style="word-wrap: break-word;min-width: 250px;max-width: 250px;" class="text-truncate">{{ $return_slip->serialnumber }}</td>
                                            ...
                                            <td class="text-nowrap">
                                                ...
                                                {{-- Edit Button --}}
                                                <a href="#" data-toggle="modal"
                                                    data-target="#updateCheckoutModal-{{ $return_slip->id }}"
                                        ...
                                        <div class="modal fade" id="updateCheckoutModal-{{ $return_slip->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-xl">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ url('admin/returns/' . $return_slip->id) }}"
                                                                ...
                                                                <div class="form-row">
                                                                    ...
                                                                    <div class="col">
                                                                        ...
                                                                        <input type="text" required name="drnumber" id="drnumber"
                                                                            class="form-control"
                                                                            value="{{ old('drnumber', $return_slip->drnumber) }}"
                                                                ...
                                                                <div class="form-row">
                                                                    ...
                                                                    <div class="col">
                                                                        ...
                                                                        <textarea name="serialnumber" id="serialnumber"
                                                                            ...
                                                                            placeholder="Enter serial no.">{{ old('serialnumber', $return_slip->serialnumber) }}</textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <form method="POST"enctype="multipart/form-data">
                                                            ...
                                                            <div class="mb-3">
                                                                <div class="form-row">
                                                                    <div class="col">
                                                                        <label for="quantity">Quantity</label>
                                                                        <input type="text" min="1" name="quantity" id="quantity" disabled
                                                                            class="form-control"
                                                                            value="{{ old('quantity', $return_slip->quantity) }}"
                                                                    ...
                                                                    <div class="col">
                                                                        <label for="serialnumber">Serial No.</label>
                                                                        <textarea name="serialnumber" id="serialnumber"
                                                                            disabled class="form-control" rows="1"
                                                                            placeholder="Enter serial no.">{{ old('serialnumber', $return_slip->serialnumber) }}</textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
