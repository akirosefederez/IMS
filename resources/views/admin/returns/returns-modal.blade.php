...
<div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
        <div class="modal-content">
            ...
            <form method="POST" action="{{ url('admin/returns/generateForm') }}" enctype="multipart/form-data"
                id="form">
                    ...
                    <div class="mb-2">
                        <div class="form-row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" required name="rsnumber" id="rsnumber" class="form-control form-control-sm"
                                    value="{{ old('rsnumber', '') }}" placeholder="Enter RS no." />
                                @error('rsnumber')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="table-responsive text-nowrap">
                            <table class="table table-bordered table-sm" id="dynamicTable">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <textarea name="addmore[0][serialnumber]" rows="1" placeholder="Serial No." class="form-control form-control-sm"></textarea>
                                    </td>
