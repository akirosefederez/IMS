...
<div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
        <div class="modal-content">
            ...
            <form method="POST" action="{{ url('admin/borrowers/generateForm') }}" enctype="multipart/form-data"
                id="form">
                <div class="modal-body">
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" name="brnumber" id="brnumber" type="text" class="form-control form-control-sm"
                            required placeholder="Enter BR No." value="{{ old('brnumber', '') }}" />
                        @error('brnumber')
...
<div class="modal fade" id="addOrderModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title" id="exampleModalLabel">Borrowed Items</h3>
                <a class="btn" data-dismiss="modal" aria-label="Close">
                    <i class="bi bi-x-circle"></i>
                </a>
            </div>
                ...
                <div class="modal-body">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col">
                                ...
                                <input type="date" required name="dateofreturn" id="dateofreturn"
                                    class="form-control form-control-sm" value="{{ old('dateofreturn', '') }}"
                    ...
                    <div class="mb-2">
                        <div class="form-row">
                            ...
                            {{-- <div class="col">
                                <label for="brnumber">BR No.</label>
                                <input type="text" required name="brnumber" id="brnumber" class="form-control form-control-sm"
                                    value="{{ old('brnumber', '') }}" placeholder="Enter BR No." />
                                @error('brnumber')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div> --}}
