...
<head>
    ...
    <style>
        ...
        #doc {
            ...
            border-collapse: collapse;
            margin-bottom: 80px;
            /* Increase the margin-bottom value as needed */
        }
...
<body>
            <div style="page-break-after: always">
                <h2 style="text-align: center;"><img src="{{ public_path('uploads/formlogo.png') }}" width="400"
                        height="75">
                </h2>
                <hr />
                ...
                <table style="width:100%;">
                    <tr style="border-style:hidden;">
                        ...
                        <td style="vertical-align: top; border-left-style:hidden;">
                            <div style="margin-bottom: 5px;font-size: 13px; text-align:right;"><b>DR No:
                                </b>{{ $drnumber }}
                            </div>
                        ...
                        <tr style="height: 156px;">
                            <td
                                ...
                                <p style="text-align: center;"><img
                                        ...
                                        height="65" /></p>
                                <div style="text-align: center; font-size:11px;">349 ORTIGAS Avenue, Brgy. Wack-wack,
                                    Mandaluyong City</div>
                                <div style="text-align: center;font-size:11px;">TEL No. (02)721-2878/721-2585 Fax No.
                                    411-1820
                                </div>
